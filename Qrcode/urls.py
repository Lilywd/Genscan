...
urlpatterns = [
    ...
    path('',include('genscan.urls')),
    
    path('password_change/', auth_views.PasswordChangeView.as_view(template_name='users/password/password_change.html'), name='password_change'),
    
    path('password_change/done/', auth_views.PasswordChangeDoneView.as_view(template_name='users/password/password_change_done.html'), name='password_change_done'),
